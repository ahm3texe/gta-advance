/* Draw the HUD minute and second tiles; the sibling DrawTwoDigits idiom — 0x0802A9F0.
 * Phase 1; compared against the ROM twins. Measurement: data/phase1_evidence/0x0802A9F0.json. */
#include "gba_types.h"
