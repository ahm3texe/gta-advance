/* Soft-float comparison; handle the NaN case separately — 0x0806D860.
 * Phase 1; compared against the ROM twins. Measurement: data/phase1_evidence/0x0806D860.json. */
#include "gba_types.h"
...
s32 FUN_0806d860(double a,double b)
{
