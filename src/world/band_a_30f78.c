...
/* --- 0x02026DF0 oturum calisma blogu (src/world/area_cleanup_b1.c) ------ */
...
/* ======================================================================= */
/* 0x08030F78 -- 12 bayt -- BYTE-MATCHING
 *
 * Oturum calisma blogunun etkinlik bayragini siliyor; 0x08030E10
 * (CaptureSessionSnapshot) onu 1 yapan kardesi. */
