/* Forwarding wrapper — 0x08014FA0-0x08014FAB
 *
 * The body only calls FUN_08014fac. Its purpose is UNKNOWN, so the
 ...
 * Verification:  make c-match FILE=src/world/wrap_08014fa0.c
 */
