/* Face the selected target and send the proximity notifications — 0x08048438.
 * Phase 1; compared against the ROM twins. Measurement: data/phase1_evidence/0x08048438.json. */
#include "gba_types.h"
...
u32 FUN_08048438(TargetActor *self)
{
