/* Soft-float comparison; handle the NaN case separately — 0x0806D9A0.
 * Phase 1; compared against the ROM twins. Measurement: data/phase1_evidence/0x0806D9A0.json. */
#include "gba_types.h"
...
s32 FUN_0806d9a0(double a,double b)
{
