/* Select the next or previous entry of the active slot — 0x0803C2C4.
 * Phase 1; compared against the ROM twins. Measurement: data/phase1_evidence/0x0803C2C4.json. */
#include "gba_types.h"
