/* Iletme sarmalayicisi — 0x08005FC4-0x08005FCF
 *
 * Govdesi yalnizca FUN_08035168 cagrisi. Ne yaptigi BILINMIYOR, bu yuzden ad
 ...
 * Dogrulama:  make c-match FILE=src/world/wrap_08005fc4.c
 */
