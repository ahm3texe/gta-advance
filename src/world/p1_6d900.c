/* Soft-float comparison; handle the NaN case separately — 0x0806D900.
 * Phase 1; compared against the ROM twins. Measurement: data/phase1_evidence/0x0806D900.json. */
#include "gba_types.h"
