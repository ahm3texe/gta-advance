/* Iletme sarmalayicisi — 0x08042784-0x0804278F
 *
 * Govdesi yalnizca FUN_08042790 cagrisi. Ne yaptigi BILINMIYOR, bu yuzden ad
 ...
 * Dogrulama:  make c-match FILE=src/world/wrap_08042784.c
 */
