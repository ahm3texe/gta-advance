/* Soft-float comparison; handle the NaN case separately — 0x0806CABC.
 * Phase 1; compared against the ROM twins. Measurement: data/phase1_evidence/0x0806CABC.json. */
#include "gba_types.h"
...
s32 FUN_0806cabc(float a,float b)
{
