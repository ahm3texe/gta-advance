 ...
 * Verification: make c-match FILE=src/ui/send_text_mode2.c
 */
...
/* 0x080315C0 — BYTE-MATCHING at its own address; see the historical
 * placement warning. Send prepared text with mode 2.
 */
void SendTextMode2(u32 text)
{
    FUN_0802af40(text, 2);
}
