...
| Human review (`documented+`) | 671 / 1941 |
| Byte-matching | 622 functions / 59004 bytes (12.99%) |
| C sources | 651 total / 609 matching |
| ROM verified from source | 40476 bytes |
| libc verification | 448 bytes |
| Total verified ROM area | 40924 bytes |
