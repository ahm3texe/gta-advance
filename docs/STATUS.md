...
| Ölçüm | Değer |
|---|---:|
| Fonksiyon haritası | 1931 fonksiyon / 443480 bayt |
| İnsan incelemesi (`documented+`) | 263 / 1931 |
| Byte-matching | 219 fonksiyon / 11956 bayt (%2.70) |
...
| TOOL-011 | P1 | todo | Sinir denetleyicisi kuyruk literal havuzlarini saymiyor | audit_boundaries.py bir fonksiyonun govdesinden SONRA gelen ve yalnizca o fonksiyonun basvurdugu literal havuzu boyuta dahil eder; 108 byte-matching kaydin boyutu bu yuzden kisaydi ve denetleyici 0 bulgu veriyordu |
